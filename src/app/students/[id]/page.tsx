...
// In Next.js 16 both params and searchParams are Promises that must be awaited.
export default async function StudentProfilePage({
  ...
  // Fetch student and their lessons in parallel.
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <form action={createLesson} className="flex flex-col gap-4">
            ...
            <Button type="submit" className="self-start">Log lesson</Button>
          </form>
        </CardContent>
      </Card>
